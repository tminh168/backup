    ...
    while True:
        ...
        if log_img:
           if direction_str1 == "In" or direction_str1 == "Out":
              cv2.imwrite("/home/mendel/coral/examples-camera/opencv/detected1" + "/count-%d.jpg" % totalCount1, cv2_im1)
           if direction_str2 == "In" or direction_str2 == "Out":
              cv2.imwrite("/home/mendel/coral/examples-camera/opencv/detected2" + "/count-%d.jpg" % totalCount2, cv2_im2)
